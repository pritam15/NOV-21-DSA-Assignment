...
public class PrintRightNode {
 ...
 {
	 PrintRightNode obj=new PrintRightNode();
	 obj.root=new ListNode(5);
	 obj.root.left=new ListNode(6);
	 obj.root.right=new ListNode(2);
	 obj.root.left.left=new ListNode(1);
	 obj.root.left.right=new ListNode(4);
	 obj.rightNode(obj.root,0);
	 System.out.println();
